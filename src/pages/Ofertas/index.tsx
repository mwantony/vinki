...
import {ReactComponent as Oferta} from 'assets/svg/ofertas.svg' 
...
export default function EmAlta() {
  ...
  return (
    <>
      <div className={styles["ofertas__title"]}>
        <Oferta></Oferta>
        <p>Ofertas</p>
      </div>
      <h3 className={styles["ofertas__produtos-encontrados"]}>
      ...
      <section className={styles["ofertas"]} ref={parent}>
        {moveisEncontrados
          ? moveisEncontrados.map((produto: any, index: any) => {
              return (
                <Link to={`/produto/${produto.idprodutos}`} className={styles["ofertas__lista--item"]}>
                  <div
