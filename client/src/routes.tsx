...
const usuario = { nome: '', tipoDeConta: '', email: '', telefone: '', cpf: '', password: '', dataDeNascimento:'' };
...
export default function AppRouter() {
    ...
    const enederecoUsuarioParsed = enderecoUsuario !== null ? JSON.parse(enderecoUsuario) : null
